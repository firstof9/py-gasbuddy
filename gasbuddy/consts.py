...
GAS_PRICE_QUERY = "query GetStation($id: ID!) { station(id: $id) { prices { cash { nickname postedTime price } credit { nickname postedTime price } fuelProduct longName } priceUnit currency id latitude longitude } }"  # pylint: disable-next=line-too-long
